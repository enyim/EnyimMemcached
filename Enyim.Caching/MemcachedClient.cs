...
//        {
//            this.pool = new DefaultServerPool(MemcachedClient2.DefaultSettings, null);
//        }
...
//            this.pool = new DefaultServerPool(section);
//        }
...
//        #region [ Store                        ]
//        private static bool Store(IServerPool pool, StoreCommand mode, string key, object value, ulong casValue, TimeSpan validFor, DateTime expiresAt)
//        {
...
//        private static bool Store(IServerPool pool, StoreCommand mode, string key, byte[] value, ulong casValue, int offset, int length, TimeSpan validFor, DateTime expiresAt)
//        {
//            if (value == null) return false;
