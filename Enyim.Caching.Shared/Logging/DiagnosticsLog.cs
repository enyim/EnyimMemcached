...
namespace Enyim.Caching
{
	public class DiagnosticsLogFactory : ILogFactory
	{
...
#if NETFX
		public DiagnosticsLogFactory() : this(System.Configuration.ConfigurationManager.AppSettings["Enyim.Caching.Diagnostics.LogPath"]) { }
#endif
		...
		public DiagnosticsLogFactory(string logPath)
		{
			...
			this.writer = File.AppendText(logPath);
		}
